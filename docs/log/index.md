...
| [2026-03-06](2026-03-06/) | Qwen3.5 兼容验证完成；transformers 5.3.0 升级；9B Stage1 训练 step_2500 完成；评测 F1≈0（thinking 模式干扰）；方向升级为终身个人记忆模型；重构 MemoryOracle（两段式 read、_background_state、修复生成污染 NLM/截断/save_load 语义等6处架构级 bug）；v2 训练数据设计完成 |
